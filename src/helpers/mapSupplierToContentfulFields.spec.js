...
const testSupplier = {
  ...
  billsAccuracyTraditional: Number("86.3"),
  smartOperating: Number("99.9"),
...
describe("mapSupplierToContentfulFields", () => {
  ...
  it("sets the contactWebchatSync field to an empty string if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactWebchatSync = { "en-GB": "" };
  ...
  it("sets the contactWebchatAsync field to null if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactWhatsappAsync = { "en-GB": null };
  ...
  it("does sets the contactInAppSync field to an empty string if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactInAppSync = { "en-GB": "" };
  ...
  it("sets the contactInAppAsync field to null if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactInAppAsync = { "en-GB": null };
  ...
  it("does sets the contactWhatsappSync field to an empty string if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactWhatsappSync = { "en-GB": "" };
  ...
  it("sets the contactWhatsappAsync field to null if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactWhatsappAsync = { "en-GB": null };
  ...
  it("sets the contactSmsSync field to an empty string if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactSmsSync = { "en-GB": "" };
  ...
  it("sets the contactSmsAsync field to null if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactSmsAsync = { "en-GB": null };
  ...
  it("sets the contactPortalSync field to an empty string if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactPortalSync = { "en-GB": "" };
  ...
  it("sets the contactPortalAsync field to null if data is not present", () => {
    let expectedSupplierFields = structuredClone(expectedFields);
    expectedSupplierFields.contactPortalAsync = { "en-GB": null };
